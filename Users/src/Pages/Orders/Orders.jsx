                ...
                <div key={o._id} className="border-b py-3">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div>
                        Total: ${o.totalAmount?.toFixed?.(2) || o.totalAmount}
                      </div>
                      <div>Status: {o.status}</div>
                    </div>
                    <div>
                      <Button onClick={() => toggle(idx)}>
                        {openIndex === idx ? <FaAngleUp /> : <FaAngleDown />}
                      </Button>
                    </div>
                  </div>
                  {openIndex === idx && (
                    <div className="mt-3">
                      ...
                      <div>
                        {o.billingDetails?.fullName} - {o.billingDetails?.phone}
                      </div>
                      <div>
                        {o.billingDetails?.address_line1},{" "}
                        {o.billingDetails?.city}
                      </div>
                    </div>
                  )}
                </div>
